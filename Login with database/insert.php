<?php
    ...
    $insert_query ="INSERT INTO `late`(`username`, `email`, `mobile`, `password`) VALUES ('$r_username','$r_email','$r_mobile','$r_pass')";
   

    $duplicate_email = mysqli_query($conn,"SELECT * FROM `late` WHERE email='$r_email'");
